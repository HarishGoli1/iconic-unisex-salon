        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-14">
          ...
          <div className="md:col-span-3">
            ...
            <div className="flex flex-col gap-4">
              <a href="tel:+919876543210" className="flex items-center gap-2.5 text-white/40 hover:text-gold transition-colors group">
                ...
                <span className="text-sm" style={{ fontFamily: 'Inter, sans-serif' }}>+91 98765 43210</span>
              </a>
              <a href="https://wa.me/919876543210" target="_blank" rel="noreferrer" className="flex items-center gap-2.5 text-white/40 hover:text-gold transition-colors">
              ...
              <div className="flex items-center gap-2.5 text-white/40">
                ...
                <span className="text-sm" style={{ fontFamily: 'Inter, sans-serif' }}>Mon–Sun, 10 AM – 8 PM</span>
              </div>
            </div>
          </div>
        </div>
