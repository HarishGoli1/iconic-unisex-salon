        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-14">
          ...
          <div className="md:col-span-4">
            ...
            <a href="#home" className="inline-flex items-center gap-3 mb-5">
              <div className="w-16 h-16 rounded-full overflow-hidden flex items-center justify-center p-1" style={{ backgroundColor: '#111' }}>
                <img
                  src={logo}
          ...
          <div className="md:col-span-3">
            ...
            <div className="flex flex-col gap-4">
              <a href="tel:+919959550829" className="flex items-center gap-2.5 text-white/40 hover:text-gold transition-colors group">
                ...
                <span className="text-sm" style={{ fontFamily: 'Inter, sans-serif' }}>+91 9959550829</span>
              </a>
              <a href="https://wa.me/919959550829" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2.5 text-white/40 hover:text-gold transition-colors">
