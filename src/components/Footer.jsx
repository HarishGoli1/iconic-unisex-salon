        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-14">
          ...
          <div className="md:col-span-3">
            ...
            <div className="flex flex-col gap-4">
              <a href="tel:+916302468858" className="flex items-center gap-2.5 text-white/40 hover:text-gold transition-colors group">
              ...
              <a href="https://wa.me/916302468858" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2.5 text-white/40 hover:text-gold transition-colors">
